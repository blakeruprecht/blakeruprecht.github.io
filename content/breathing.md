...
- **Zen** = breathe in, breathe out. Sit up straight. Relax your body. Open shoulders, neutral hips. In thru the nose, out thru the mouth.
- **Box Breathing** = follow a loop of four steps: (1) Breathe in (2) Hold (3) Breathe out (4) Hold. Do each step for 4 seconds.
- **Slow Breathing** = in thru the nose, out thru the mouth. Try to slow down each breath until the breath in takes 30 seconds or at least a lot.

## The Sword
Breathing can slash thoughts.

Focus on breathing in, then breathing out.

Return your focus to your breathing every time you get distracted.

In and out.

Use this conscious refocusing of attention from thought to breath over and over.

You will never stop the flow of thoughts. When you get better at refocusing on the breath, consciouscly focusing on the topic of your choosing, you'll begin to slash your thoughts.

You'll unlock the power to slice through the spaghetti loops of thinking. No need to figure it all out. Just focus on the breath and ignore your thinking entirely.

When the thoughts are cleared, we return to stillness, the ground truth.
...
## Earth: from Survival to Integrity
- **Survival** - Good, I'm alive. I want to stay alive. Secure myself.
- **Responsibility** - I can only control my response in this moment to what is real, nothing else. I am here, now. Now what?
- **Ownership** - I own everything: my choices, words, space, and relationships.
...
- **Acceptance** - You can't control feeling, you can just move with it.
- **Attention** - Love means paying attention. Where I look is what I love. Listen to your body, your feelings, the unspoken vibes between people.
- **Presence** - Stay with the what's happening. Let go of the past. Release control.
- **Connection** - Really being with others and allowing yourself to be seen.
- **Surrender** - Drop the self-consciousness, the performance. Melt. Dance, laugh, play. Flow with love.

## Fire: from Fear to Creation
- **Fear** - I could die at any moment. Death gives life meaning. Fear shoes me that something matters. Inaction (procrastination, perfectionism, escapism) is a slow death.
- **Urgency** - [Time](/time) is real. There's won't be another chance. This is the moment.
- **Courage** - I move *with* fear, not after it fades. I act when scared, exposed, and uncertain.
- **Confidence** - I build momentum by doing. Regret is worse than failure.
- **Wholehearted** - I go all in, full send -- body, heart, mind, and spirit. To love is to risk.
- **Leadership** - I go first. I set the tone. I ask for what I want.
- **Creation** - I shape the world with my actions. Passion is contagious.
...
_Universal Declaration of Human Rights_ by the United Nations

**Paulo Coehlo**, _The Alchemist_.

- “Maktoub” means it is written, but even though the path is written, it’s still our choice to go down it.

**Sylvester Stallone**, _Rocky Balboa_.
...
**Simple acts of kindess** -- a Thai commercial I found on [reddit](https://www.reddit.com/r/taoism/comments/1i0il8q/if_taoism_had_a_tv_spot_the_original_post_with/). 
